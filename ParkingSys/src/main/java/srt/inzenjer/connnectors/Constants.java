...
public interface Constants {
    ...
    String REGISTER_URL="http://192.168.1.13/myparking/mRegisterUser.php?";
    String LOGIN_URL="http://192.168.1.13/myparking/mLoginUser.php?";
/*    String REQUESTLOC_URL="http://192.168.1.9/smartmeter/user_api/mLocServices.php?";
    ...
    String PROFILEUP_URL="http://192.168.1.9/smartmeter/user_api/mProupdate.php?";*/
